...
import { generateValentineLevel, generateFallbackLevel, BACKUP_LEVELS } from './services/gemini-service';
...
const App: React.FC = () => {
  ...
  const startGame = async (useAI: boolean = true) => {
    ...
    try {
      ...
      console.error(e);
      setError(e.message || "ไม่พบรูปภาพสำรองที่คุณอัปโหลด กรุณาตรวจสอบไฟล์ backup1.png ถึง backup4.png");
